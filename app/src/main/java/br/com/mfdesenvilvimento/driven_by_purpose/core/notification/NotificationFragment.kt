...
//        binding.update.setOnClickListener { updateNotification() }    // enviar notificação padrão
//        binding.cancel.setOnClickListener { cancelNotification() }    // enviar notificação padrão
//
//    }
//
...
//        setupUiButtonStates(enableNotify = false, enableUpdate = false, enableCancel = true)
    ...
    private fun sendNotification() {
        ...
        NOTIFICATION_ID.createNotificationAction(builder, ACTION_UPDATE, "Atualize")
        NOTIFICATION_ID.createNotificationAction(builder, ACTION_CANCEL, "Remover")
...
//        setupUiButtonStates(enableNotify = false, enableUpdate = true, enableCancel = true)
    ...
    private fun Int.createNotificationAction(
